...
## Project Report
Report can be accessed here: [report/DSC\_202\_Cinescope.pdf](report/DSC_202_Cinescope.pdf). Be sure to select "More pages" at the bottom of each page if you view the report in the Github interface.
## Slides
