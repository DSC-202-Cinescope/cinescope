    ...
    for df_chunk in tqdm(reader, total=(total_actor_movie_rows // actor_chunksize) + 1, desc="Importing Actor-Movie Relationships"):
        with driver.session() as session:
            for _, row in df_chunk.iterrows():
                ...
                movie_list = [1322875, 1330477, 1379661, 1396469, 1396472, 1396475, 1419636, 13, 105, 165, 196, 901, 914, 3082, 32251, 48499, 48501, 113268, 211280, 230364, 237353, 251971, 269779, 277223, 289927, 294145, 317129, 321825, 340979, 380614, 412416, 451306, 469254, 479864, 499368, 501957, 551431, 578873, 691742, 701955, 749822, 882096, 888545, 924881, 988632, 989131, 1139605, 1171960]
